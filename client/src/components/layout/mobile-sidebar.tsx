  ...
  return (
    <>
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 border-b bg-white z-30 flex items-center px-4 shadow-sm">
        ...
        <Link href="/">
          <a className="text-lg font-bold ml-4">
      ...
      <aside
        className={`fixed inset-y-0 left-0 w-64 bg-white z-50 transform transition-transform duration-200 ease-in-out md:hidden ${
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b">
          ...
          <button className="text-muted-foreground" onClick={closeSidebar}>
            <X className="h-5 w-5" />
          </button>
        </div>
