...
export default function Sidebar({ user, isOpen, onClose }: SidebarProps) {
      ...
      if (savedGroups) {
        ...
        const allPagesGroupedByArea: Record<string, Array<{id: string, name: string}>> = {
          'MAIN': [
            ...
            { id: 'leads-steps', name: 'Leads Steps' },
          ...
          'EVENTS': [
            ...
            { id: 'events/venue-planner', name: 'Venue Planner' },
            { id: 'events/staff', name: 'Staff Management' },
            { id: 'events/team-portal', name: 'Team Portal' },
            { id: 'events/travel', name: 'Travel & Accommodations' },
            { id: 'events/registration', name: 'Registration System' },
            { id: 'events/checkin-tools', name: 'Check-In Tools' },
            { id: 'events/financial', name: 'Financial Management' },
            { id: 'events/budget-tracker', name: 'Budget Tracker' },
            { id: 'events/swag-manager', name: 'Swag Pack Manager' },
            { id: 'events/media-panel', name: 'Marketing & Media Panel' },
  ...
  const applyCustomSettings = (defaultMenuGroups: MenuGroup[]): MenuGroup[] => {
    ...
    const iconMap: Record<string, React.ReactNode> = {
      ...
      'events/venue-planner': <MapPin className="mr-2" size={16} />,
      'events/staff': <UsersRound className="mr-2" size={16} />,
      'events/team-portal': <UsersRound className="mr-2" size={16} />,
      'events/travel': <Plane className="mr-2" size={16} />,
      'events/registration': <Users className="mr-2" size={16} />,
      'events/checkin-tools': <Calendar className="mr-2" size={16} />,
      'events/financial': <BadgeDollarSign className="mr-2" size={16} />,
      'events/budget-tracker': <BadgeDollarSign className="mr-2" size={16} />,
      'events/swag-manager': <Shirt className="mr-2" size={16} />,
      'events/media-panel': <MessageCircle className="mr-2" size={16} />,
      ...
      defaultMenu = [
        ...
        },
        {
          ...
          items: [
            ...
            {
              name: "Budget Tracker",
              href: "/events/budget-tracker",
              icon: <BadgeDollarSign className="mr-2" size={16} />,
            },
            {
              name: "Swag Pack Manager",
              href: "/events/swag-manager",
              icon: <Shirt className="mr-2" size={16} />,
            },
            {
              name: "Marketing & Media",
              href: "/events/media-panel",
